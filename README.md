Selenium Composer is a simple tool, which setup a local grid under windows and ubuntu. It get the actual selenium server with matching drivers for edge, ie11, chrome and firefox. 
